'''
8. Escreva uma função recursiva que realize uma divisão inteira de dois números inteiros, sem usar o 
operador de divisão. A função deve retornar o quociente da divisão.
'''
